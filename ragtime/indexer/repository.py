...
class IndexerRepository:
    ...
    async def get_settings(self) -> AppSettings:
        ...
        return AppSettings(
            ...
            # LLM settings
            llm_provider=getattr(settings, "llmProvider", DEFAULT_LLM_PROVIDER),
            llm_model=getattr(settings, "llmModel", DEFAULT_LLM_MODEL),
            llm_max_tokens=getattr(settings, "llmMaxTokens", DEFAULT_LLM_MAX_TOKENS),
            ...
            max_iterations=getattr(settings, "maxIterations", DEFAULT_MAX_ITERATIONS),
            ...
            odoo_container=getattr(settings, "odooContainer", DEFAULT_LEGACY_ODOO_CONTAINER),
            postgres_container=getattr(settings, "postgresContainer", DEFAULT_LEGACY_POSTGRES_CONTAINER),
            postgres_host=settings.postgresHost,
            postgres_port=getattr(settings, "postgresPort", DEFAULT_LEGACY_POSTGRES_PORT),
            ...
            max_query_results=getattr(settings, "maxQueryResults", DEFAULT_MAX_QUERY_RESULTS),
            query_timeout=getattr(settings, "queryTimeout", DEFAULT_QUERY_TIMEOUT_SECONDS),
            ...
            ivfflat_lists=getattr(settings, "ivfflatLists", DEFAULT_IVFFLAT_LISTS),
            ...
            # MCP configuration
            mcp_enabled=getattr(settings, "mcpEnabled", DEFAULT_MCP_ENABLED),
            ...
            # OCR configuration
            default_ocr_mode=OcrMode(_normalize_ocr_mode_value(getattr(settings, "defaultOcrMode", DEFAULT_OCR_MODE))),
            default_ocr_provider=(
                OcrProvider(default_provider) if (default_provider := getattr(settings, "defaultOcrProvider", DEFAULT_OCR_PROVIDER)) else None
            ),
