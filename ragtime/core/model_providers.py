...
MODEL_PROVIDERS: dict[str, ModelProvider] = {
    ...
    "openai_codex": ModelProvider(
        name="openai_codex",
        label="OpenAI Codex",
        aliases=("codex", "chatgpt_codex", "openai-codex"),
        llm_api_key_field="openai_codex_access_token",
        embedding_api_key_field="openai_codex_access_token",
        supports_llm=True,
        supports_embeddings=True,
        openai_compatible_chat=True,
        openai_compatible_embeddings=True,
