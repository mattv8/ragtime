    ...
    async def get_settings(self) -> dict:
        ...
        try:
            ...
            self._settings = {
                ...
                "chat_enabled": getattr(prisma_settings, "chatEnabled", True),
                "userspace_generation_enabled": getattr(prisma_settings, "userspaceGenerationEnabled", True),
            ...
            return {
                ...
                "show_tool_card_footer_actions": DEFAULT_SHOW_TOOL_CARD_FOOTER_ACTIONS,
                "tool_skills_enabled": DEFAULT_TOOL_SKILLS_ENABLED,
                "chat_enabled": True,
